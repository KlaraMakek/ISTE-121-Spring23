...
- GUI designed as requested 1/1
- A recursion method implemented 2/2
- DirectoryChooser is opened on the Select button 1/1
- Total number of files works 1/1
- Total number of directories works 1/1
- Total bytes implemented 1/1
- The TextArea preview works (d- and f-) 2/2
- Dots added to show the indentation 1/1
