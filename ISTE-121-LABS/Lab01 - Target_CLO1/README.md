...
- Label and TextField placed properly (2/2)
- Buttons placed properly (2/2)
- TextField for amout is disabled (0/1) - missing
- Button exit works as requested  (0.5/0.5)
- Button Clear works as requested (0.5/0.5)
- Button Calculate works as requested (2/2)
- Button Save works as requested (1/2) –the calculate statements should be in a method, more values in the cvs file than needed (too complex csv)
