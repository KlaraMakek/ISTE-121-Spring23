...
public class Counter2 extends Application implements EventHandler<ActionEvent> {
    ...
    private ResetLisener lisener = new ResetLisener(this);
    ...
    public void start(Stage _stage) throws Exception {
        ...
        stage.setTitle("Exercise 2 part 2"); // set the text in the title bar

        // Set up counetr in 1st part of VBOX
